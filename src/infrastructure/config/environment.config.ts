...
export class EnvironmentConfig {
  ...
  load(): IEnvironmentConfig {
    ...
    const rawConfig = {
      ...
      sync: {
        intervalMinutes: process.env.SYNC_INTERVAL_MINUTES ? parseInt(process.env.SYNC_INTERVAL_MINUTES, 10) : undefined,
        batchSize: process.env.SYNC_BATCH_SIZE ? parseInt(process.env.SYNC_BATCH_SIZE, 10) : undefined,
