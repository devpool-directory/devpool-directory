export abstract class BaseError extends Error {
  ...
  constructor(message: string, code: string, statusCode?: number, isOperational: boolean = true, details?: any) {
    super(message);
...
export class ExternalServiceError extends BaseError {
  constructor(service: string, message: string, statusCode?: number, details?: any) {
    super(`External service error (${service}): ${message}`, "EXTERNAL_SERVICE_ERROR", statusCode || 503, true, { service, ...details });
  }
}
