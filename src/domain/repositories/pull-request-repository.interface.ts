...
export interface PullRequestRepository {
  ...
  create(owner: string, repo: string, pullRequest: {
    title: string;
    body: string;
    head: string;
    base: string;
  ...
  update(owner: string, repo: string, pullNumber: number, updates: {
    title?: string;
    body?: string;
    state?: 'open' | 'closed';
    base?: string;
  ...
  merge(owner: string, repo: string, pullNumber: number, options?: {
